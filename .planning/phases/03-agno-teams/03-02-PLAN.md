...
<task type="auto">
  ...
  <files>hfs/agno/teams/__init__.py, hfs/presets/hierarchical.py</files>
  <action>
1. **Update hfs/agno/teams/__init__.py:**
   Add HierarchicalAgnoTriad to exports:
   ```python
   from .hierarchical import HierarchicalAgnoTriad
   ```

2. **Update hfs/presets/hierarchical.py:**
...
```
  ...
  <done>
HierarchicalAgnoTriad exported from hfs.agno.teams, existing preset has deprecation notice.
  </done>
</task>
